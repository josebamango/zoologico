            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a href="{{route('animales.index')}}"
                       class="nav-link {{ request()->routeIs('animales.*') && !request()->routeIs('animales.create')? ' active' : ''}}">Listado
                        de animales</a>
                </li>
                <li class="nav-item">
                    <a href="{{route('animales.create')}}"
                       class="nav-link {{ request()->routeIs('animales.create')? ' active' : ''}}">Nuevo animal</a>
                </li>
