...
class AnimalController extends Controller
{
    private $animales = array(
        array(
            ...
            'descripcion' => 'Los bisontes son potentes ungulados de carácter muy vivaz y de una asombrosa agilidad. Forman rebaños independientes de machos y hembras que se unen únicamente en la época de celo, en la que los machos están más gordos y vigorosos.
            Finalizado este periodo, las hembras se alejan de la manada y vuelven a su vida tranquila. Nueve meses después dan a luz un ternero, que permanecerá junto a su madre.
        ...
        array(
            ...
            Los grupos de elefantes se desplazan siempre en fila india, siguiendo un orden preestablecido según la jerarquía de cada miembro, y se moverán de un punto a otro dependiendo de las decisiones de la matriarca, que es quien dicta cuándo y a dónde dirigirse.
            Los elefantes se comunican contínuamente a través de diferentes tipos de señales, algunas de ellas imperceptibles para el hombre por su baja frecuencia, pero que éstos pueden escuchar a más de 10 kilómetros de distancia. El nacimiento de una nueva cría es un acontecimiento importanta para la manada: ésta, además de por su madre, será cuidada por el grupo.
        ...
        array(
            ...
            'imagen' => 'leon.jpg',
            'alimentacion' => 'carnívoro',
            'descripcion' => 'Los leones son los únicos felinos que viven formando un grupo social jerarquizado con una división clara de papeles: los machos vigilan y defienden el territorio y las hembras cazan y cuidan de los cachorros.
    ...
    {
        return view("animales.index", ["arrayAnimales"=>$this->animales]);
    }
    ...
    {
        return view("animales.show", ["arrayAnimales" =>$this->animales[$id]]);
    }
